...
class PointOfInterestCategoriesController < ApplicationController
  ...
  private
    ...
    def convert_params_for_graphql
      ...
      # convert OpenStreetMap fields
      if @point_of_interest_params["open_street_map"].present?
        @point_of_interest_params["open_street_map"]["capacity"] = @point_of_interest_params["open_street_map"]["capacity"].to_i
      end
